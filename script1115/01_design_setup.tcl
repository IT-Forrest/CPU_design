...
exec Milkyway -f ${macro_db_path}/lef2cel_1115.tcl  &
# manually close Milkyway # menuQuit
}

 ## Create the CHIP Libaray if Not Exist
if {![file exist CHIP1111]} {create_mw_lib  -technology ${icc_tech_file} -mw_reference_library [list ${icc_ref_lib} ${icc_pad_lib} ${macro_db_path}/${sram_db_name}] -bus_naming_style {[%d]} -open CHIP1111}
open_mw_lib CHIP1111
