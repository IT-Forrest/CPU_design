...
set_operating_conditions -min_library ${ibm_sram_min_db_name}.db:RA1SHD_IBM1024X8 -min ff_1p32v_m40c -max_library ${ibm_sram_max_db_name}.db:RA1SHD_IBM1024X8 -max ss_1p08v_125c -analysis_type on_chip_variation
